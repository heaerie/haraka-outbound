...
exports.send_email = function () {
    ...
    console.log("### call send_trans_email");
...
exports.send_trans_email = function (transaction, next) {
	...
	console.log("PSTER:001");
        ...
        var todo_index = 1;
	console.log("PSTER:002");

        async.forEachSeries(deliveries, function (deliv, cb) {
		console.log("PSTER:002.001", deliv);
	...
	console.log("PSTER:003");
    }

    console.log("STM:002 call pre_send_trans_email");
    plugins.run_hooks('pre_send_trans_email', connection);
};

exports.process_delivery = function (ok_paths, todo, hmails, cb) {
    var self = this;
    console.log("###:PD:001:", ok_paths, todo, hmails);
    this.loginfo("Processing domain: " + todo.domain);
    console.log("###:PD:002:todo.domain", todo.domain);
    var fname = _fname();
    console.log("queue_dir:", queue_dir);
    console.log("platformDOT:", platformDOT);
    ...
    ws.on('error', function (err) {
        console.log("Unable to write queue file (" + fname + "): " + err);
